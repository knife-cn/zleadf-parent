...
//    总条数
    ...
    Map getIndexInfo(@Param("memberId")Long memberId);
     ...
     */
    Integer findStatisticsOrderListCount(@Param("memberId") Long memberId,@Param("timeType")String timeType);
     ...
     * @return
     */
    BigDecimal countOrderAmountByAgentId(@Param("agentId") Integer agentId, @Param("shopId")Long ownShopid);
     ...
     * @return
     */
    Integer countOrderNumberByAgentId(@Param("agentId") Integer agentId, @Param("shopId")Long ownShopid);
