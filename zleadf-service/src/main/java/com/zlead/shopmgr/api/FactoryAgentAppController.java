...
import com.zlead.entity.vo.AgentPictureListVO;
import com.zlead.entity.vo.OaAgentMasBaseInfoVo;
...
public class FactoryAgentAppController {
    ...
    public JsonResult factoryAgentList(@RequestParam(value = "keyword", required = false)  String keyword,
        ...
        if (member == null) {
            ...
            try{
                jsonResult = factoryAgentService.queryAgentList(member.getId(), keyword, levelId);
            } catch (Exception e){
                e.printStackTrace();
            }
        }
        ...
        if (member == null) {
            ...
            if(oaAgentMas != null){
                ...
                if(StringUtils.isNotBlank(agentDiscount)){
                    String percent = MathUtils.parsePercent(Double.parseDouble(agentDiscount));
