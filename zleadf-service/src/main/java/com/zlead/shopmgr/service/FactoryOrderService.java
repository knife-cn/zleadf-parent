...
public interface FactoryOrderService {
     ...
     * @return
     */
    Map<String, Object> agentTradeSummary(Integer agentId, Long ownShopid);
    ...
    int generateAppOrder(OrderGoodsDto orderGoodsDto,MemberEntity memberEntity, Long shopId, HttpServletRequest request);
