...
public interface FactoryGoodsService {
    ...
    List<GoodsListVo> findPrdInventList(Long memberId, Integer agentId,String fullName,Integer brandId,Integer listId,Integer modelId,Integer catId, Set<Integer> whIds, PageBounds rowBounds);
    ...
    AgentFac getAgentFactByMemberId(Long id);

    void updateGoodsListBySalePrice(GoodsListVo vo);

    GoodsDetailVo findPrdInventDetail(Integer agentId, Integer goodsId,Integer shopId);
}
