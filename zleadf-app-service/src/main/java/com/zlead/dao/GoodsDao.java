...
public interface GoodsDao {
    ...
    List<GoodsListVo> findPrdInventList(@Param("memberId") Long memberId, @Param("fullName") String fullName,
                                        @Param("brandId") Integer brandId,
                                        @Param("listId") Integer listId,
                                        @Param("modelId") Integer modelId,
                                        @Param("catIds") Collection<Integer> catIds,
                                        @Param("whIds")  Collection<Integer> whIds,
                                        PageBounds rowBounds);

    void updateGoodsListBySalePrice(BigDecimal marketPrice);
}
