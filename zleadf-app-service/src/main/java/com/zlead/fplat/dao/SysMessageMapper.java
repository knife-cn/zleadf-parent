...
public interface SysMessageMapper {
     ...
     * @return
     */
    Integer hasNotReadSysMsg(@Param("memberId") Long memberId,@Param("agentIds")Set<Integer> agentIds);
     ...
     * @return
     */
    List<SysMsgListVO> notReadSysMsgList(@Param("memberId")Long memberId, @Param("agentIds")Set<Integer> agentIds, PageBounds pageBounds);
    ...
    Integer tagSysMsgAll(Long memberId);
}
