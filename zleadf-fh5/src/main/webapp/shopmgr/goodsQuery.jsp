...
<meta charset="utf-8" />
		...
		<script type="text/javascript" src="./js/control/goodsQuery.js?v=1.1"></script>
</head>
<body>
<div id="errorMsg"></div>
<div class="orderInfo">
	<div class="orderTitle">
		...
		<span>商品查询</span>
		<img class="goodsBtn" src="img/btn-spsj.png" alt="" onclick="gotoGoodsUpload()">
	</div>
	<div class="list-1">
		<ul>
			<li style="width:15%">名称</li>
			<li style="width:15%">类别</li>
			<li style="width:15%">售价</li>
			<li style="width:11%">状态</li>
			<li style="width:13%">库存</li>
			<li style="width:13%">销量</li>
