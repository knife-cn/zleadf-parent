...
public class DateTool {
	 ...
	 * @return Date
	 */
	public static Date parseDateNew(String dateValue) {
		return parseDate(C_DATE_PATTON_yyyyMM, dateValue);
	}
	 ...
	 * @return 转换后符合给定格式的日期字符串
	 */
	public static String formatNew(Date aTs_Datetime) {
		return format(aTs_Datetime, C_DATE_PATTON_yyyyMM);
	}
	/**
	 * 将Timestamp类型的日期转换为系统参数定义的格式的字符串
	 * 
 ...
 */
	...
	public static List<String> timeSepreate(String begin_date,String end_date){
		...
		Date begin_d = DateTool.parseDate(begin_date);
		Date end_d = DateTool.parseDate(end_date);
		String begin_d_d = "";
		do{
			begin_d_d = DateTool.format(begin_d);
			str.add(begin_d_d);
			begin_d = DateTool.addDays(begin_d, 1);
	 ...
	 * @return
	 */
	public static Date getWeekBeginByNowDate(){
		Calendar cal = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static Date getMonthBeginByNowDate(){
		Calendar cal = Calendar.getInstance();
		cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONDAY), cal.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
	 ...
	 * @return
	 */
	public static Date getQuarterBeginByNowDate(){
		Calendar c = Calendar.getInstance();
		int currentMonth = c.get(Calendar.MONTH) + 1;
		SimpleDateFormat longSdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		SimpleDateFormat shortSdf = new SimpleDateFormat("yyyy-MM-dd");
		Date quarterBegin = null;
		try {
			...
			quarterBegin = longSdf.parse(shortSdf.format(c.getTime()) + " 00:00:00");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return quarterBegin;
