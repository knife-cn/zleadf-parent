...
public interface CrmPrdCatMapper {
     ...
     * @return
     */
    List<Map<String, Object>> findOneByIdMap(@Param("ids") List<Integer> ids);
    /**
     * 通过catId查询分类
     * @param ids
     * @return
     */
    List<CrmPrdCat> findOneByIdList(@Param("ids") List<Integer> ids);

    List<Integer> findCatIdsByCondition(@Param("agentId") Long agentId, @Param("factoryId")Long factoryId, @Param("catIds")Set<Long> catIds);
}
