...
public interface SysMessageService {
     ...
     */
    void insertOrderSysMsg(OrderEntity order, MemberEntity memberEntity, Integer msgType,Integer shopId);
     ...
     * @param amount
     */
    void insertVoucherSysMsg(MemberEntity memberEntity, BigDecimal amount,Integer shopId);
