...
public class MemberAddressServiceImpl implements MemberAddressService {
    ...
    public List<MemberAddrVo> getAppMemberAddr(Integer agentId,Long memberId) {
        ...
        for (MemberAddrVo addr : list) {
            ...
            addrVo.setProvinceId(provinceName);
            addrVo.setCityId(cityName);
            addrVo.setAreaId(areaName);
    ...
    public boolean save(MemberAddrVo memberAddrVo,MemberEntity memberEntity) {
        ...
        addressEntity = memberAddressDao.findAddrId();
        //添加rev_info表
        if(null!=addressEntity){
        	agentAddress.setRevDefault(addressEntity.getIsDefault().toString());
