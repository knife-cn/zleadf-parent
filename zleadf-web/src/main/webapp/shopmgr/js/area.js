...
var provinceList = [
    ...
    {name:'天津市', cityList:[
            {name:'市辖区', areaList:['静海区','宁河区','和平区','河东区','河西区','南开区','河北区','红桥区','塘沽区','汉沽区','大港区','东丽区','西青区','津南区','北辰区','武清区','宝坻区']},
            {name:'县', areaList:['蓟　县']}
        ]},
    {name:'重庆市', cityList:[
            {name:'市辖区', areaList:['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区','江津区','合川区','永川区','南川区']},
    ...
    {name:'台湾省', cityList:[
			{name:'台北市',areaList:['中正区', '大同区', '中山区', '松山区', '大安区', '万华区', '信义区', '士林区', '北投区', '内湖区', '南港区', '文山区']},
			{name:'新北市',areaList:['板桥区', '汐止区', '新店区', '永和区', '中和区', '土城区', '树林区', '三重区', '新庄区', '芦洲区', '瑞芳区', '三峡区', '莺歌区', '淡水区', '万里区', '金山区', '深坑区', '石碇区', '平溪区', '双溪区', '贡寮区', '坪林区', '乌来区', '泰山区', '林口区', '五股区', '八里区', '三芝区', '石门区']},
            ...
            {name:'高雄市',areaList:['楠梓区', '左营区', '鼓山区', '三民区', '盐埕区', '前金区', '新兴区', '苓雅区', '前镇区', '旗津区', '小港区', '凤山区', '大寮区', '鸟松区', '林园区', '仁武区', '大树区', '大社区', '冈山区', '路竹区', '桥头区', '梓官区', '弥陀区', '永安区', '燕巢区', '阿莲区', '茄萣区', '湖内区', '旗山区', '美浓区', '内门区', '杉林区', '甲仙区', '六龟区', '茂林区', '桃源区', '那玛夏区']},
            {name:'基隆市',areaList:['中正区', '中山区', '七堵区', '暖暖区', '仁爱区', '安乐区', '信义区']},
            {name:'新竹市',areaList:['东区', '北区', '香山区']},
            {name:'嘉义市',areaList:['东区', '西区']},
            {name:'省直辖县级行政单位',areaList:['新竹县', '苗栗县', '彰化县', '南投县', '云林县', '嘉义县', '屏东县', '宜兰县', '花莲县', '台东县', '澎湖县', '金门县', '连江县']},
            {name:'钓鱼岛列岛',areaList:['钓鱼岛', '南小岛', '北小岛', '赤尾屿', '黄尾屿', '北屿', '南屿', '飞濑岛']}
        ]},
