...
<meta charset="utf-8" />
		...
		<script type="text/javascript" src="./js/control/login.js?v=1.1"></script>
		<script type="text/javascript" src="./js/control/logout.js?v=1.1"></script>
<title>宏古</title>
</head>
<body>
<div id="errorMsg"></div>
...
<div class="wrap">
	...
	<div class="login-info">
		...
		<div class="foget-password" onclick="gotoPassword()">
			<img src="img/icon-wangji.png" alt=""/>
			<span style="color:#fff;font-size:0.2rem;">忘记密码</span>
		</div>
	</div>
