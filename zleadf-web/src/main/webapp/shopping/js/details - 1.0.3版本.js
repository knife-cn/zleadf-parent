                    ...
                    $("#dtgocart").click(function() {
                        ...
                        if ($(".dt_yul").length == $(".avtie").length) { // 判断当前是否所有参数都选中
                            if ($('#quantity').val() > 0) { //判断数量是否正确
                                ...
                                //         // if(res.code == 1){
                                //         // 获取当前参数的商品状态和数量
                                //         for (var i = 0; i < res.data.attrVals.length; i++) {
                                //             var flag = true;
                                //             for (var j = 0; j < $(".avtie").length; j++) {
                                //                 var str = $('.avtie').eq(j).find('p').html();
                                //                 if (res.data.attrVals[i].attr_val.indexOf(str) == -1) {
                                //                     flag = false;
                                //                 }
                                //             }
                                //             if (flag) {
                                //                 // 当前数量,如果需要判断商品状态，请在这里获取商品状态
                                //                 var num = res.data.attrVals[i].stock;
                                //                 var goodsId = res.data.attrVals[i].goods_id;
                                //             }
                                //         }
                                //         // $("#megou").show();
                                //         $("body").css('overflow-y', 'hidden');
                                //         // var goodsId = $("#shoppid_de").html();
                                ...
                                if (mystore.length > 0) {
                                    for (var i = 0; i < mystore.length; i++) {
                                        ...
                                        if (flag) {
                                            // 当前数量,如果需要判断商品状态，请在这里获取商品状态
                                            var num = mystore[i].stock;
                                            var goodsId = mystore[i].goods_id;
                                        }
                                    }
                                }
                                if (goodsId) {
                    ...
                    $("#payfor2").click(function() {
                        if ($(".dt_yul").length == $(".avtie").length) { // 判断当前是否所有参数都选中
                            if ($('#quantity').val() > 0) { //判断数量是否正确
                                ...
                                //             }
                                //             if (flag) {
                                //                 // 当前库存数量,如果需要判断商品状态，请在这里获取商品状态
                                //                 var num = res.data.attrVals[i].stock;
                                //                 var goodsId = res.data.attrVals[i].goods_id;
                                //             }
                                //         }
                                //         var count = $("#quantity").val();
                                //         // 备注：这里不做判断，判断再zhifu函数里面判断
