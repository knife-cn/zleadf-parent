...
// $('.navt').children('ul').children('li').eq(status).addClass('active').siblings('li').removeClass('active');
$(function() {
    ...
    if (window.localStorage.getItem("active5") != undefined) {
        ...
        // findPageZero(pageNum, 0);
        // findPageZero(pageNum, 1);
        // findPageZero(pageNum, 2);
        // findPageZero(pageNum, 3);
        findPageZero(pageNum);
    }
    ...
    // $('#h3Ele22').click(function() {
    //     $(".boxshaw1").show();
    //     return false;
    // });

    // $('#schedule-box12').click(function() {
    //     return false;
    // });
    ...
    $("#fo82").click(function() {
        ...
        payTime = $("#h3Ele22").val();
        amount = $("#inputs2").val();
        payWayAll = $("#payWayAll").val();
        if (amount == "") {
            $("#inputs2").css("border-color", "rgb(253, 87, 0)");
            $("#payWayAll").css("border-color", "rgb(229, 229, 229)");
            ...
            $("#payWayAll").css("border-color", "rgb(253, 87, 0");
            $("#h3Ele22").css("border-color", "rgb(229, 229, 229)");
            $(".tipsNo").text("请选择付款方式");
            $(".tipsNo").show();
        } else if (payTime == "") {
...
function findPageZero(pageNum, status) {
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            //     // var id = $(this).attr("data-idP1");
            //     cancelD($(this).attr("data-idP1"));
            // });
            ...
            $('.wdetail3').click(function() {
                ...
                // if (vStatus == 0) { //创建订单
                //     window.location.href = "User_center2.html?id=" + id
                // } else if (vStatus == 1) { //付款成功
                //     window.location.href = "User_center3.html?id=" + id
                // } else if (vStatus == 2) { //商品出库
                //     window.location.href = "User_center4.html?id=" + id
                // } else if (vStatus == 3) { //完成订单
                //     window.location.href = "User_center5.html?id=" + id
                // }
            })
        },
...
// $('#h3Ele2').click(function() {
//     $(".boxshaw1").show();
//     return false;
// })

// $('#schedule-box1').click(function() {
//     return false;
// })

// 日期插件功能补充：

// $(".boxshaw1").find('.other-month').children('span').click(function() {
//     $(".boxshaw1").hide();
//     $('#h3Ele22').val($(this).attr('title'));
// })
...
//         type: "post", //提交请求的方式
//         cache: true, //是否有缓存
//         url: "/zlead/order/cancelOrder", //访问servlet的路径
//         dataType: "json", //没有这个，将把后台放会的json解析成字符串
//         async: true, //是否异步
//         data: {
//             orderId: id,
...
// 待收货 status=2 页面结构  ==> 本页面暂时不做
// <div class="ding">
//     <div class="bian">
//         <div class="biao"><img src="../../shopping/img/lhpimg/ic_date.png" /></div>
//         <div class="shi">2019/01/01</div>
//         <div class="hao"><span>订单号:</span><span>259954695663626096</span></div>
//         <div class="shan"><img src="../../shopping/img/lhpimg/Edit_Copy1.png" /></div>
//     </div>
//     <div class="nei">
//         <div class="img">
//             <img src="../../shopping/img/lhpimg/Bitmap27.png" />
//         </div>
//         <div class="miao">
//             <span>手电转家用充电式电动螺丝刀手枪电钻迷你工具2V小锂电手钻电转</span>
//             <span>参数&nbsp;:&nbsp;'+res.OrderGoods[j].goodsAttriValue+'</span>
//         </div>
//         <div class="shulian">1</div>
//         <div class="shulian"><span>￥</span><span>200</span></div>
//         <div class="shulian yan">待收货</div>
//         <div class="threetai">
//             <div class="threetai1">
//                 <span>查看订单进度</span>
//                 <img src="../../shopping/img/lhpimg/2.png" class="img1" />
//                 <img src="../../shopping/img/lhpimg/4.png" class="img2" />
//             </div>
//             <div class="threetai2">订单详情</div>
//             <div class="xianqing9">
//                 <div class="xq19">共计12件商品，合计: <span>¥12444.90</span> (运费: 50.00)</div>
//                 <div class="xq29">
//                     <div>收货地址：</div>
//                     <div>内蒙古自治旗鄂尔多斯市东省自治县沙河发卡行发酵技术盟</div>
//                 </div>
//                 <div class="geli9"></div>
//                 <div class="xq39">
//                     <div class="xq319">
//                         <div class="xqleft9">
//                             <img src="../../shopping/img/lhpimg/Fill_2.png" />
//                             <div class="tiao9"></div>
//                         </div>
//                         <div class="xqright9">
//                             <span>完成收货</span>
//                             <div>22019/10/14 12:12:12</div>
//                         </div>
//                     </div>
//                     <div class="xq329">
//                         <div class="xqleft329">
//                             <div class="dian329"></div>
//                             <div class="tiao9"></div>
//                         </div>
//                         <div class="xq32div9">
//                             <span>商品出库</span>
...
//                     <div class="xq339">
//                         <div class="xqleft339">
//                             <div class="dian339"></div>
//                             <div class="tiao9"></div>
//                         </div>
//                         <div class="xq33right9">
//                             <span>订单以出库</span>
//                             <div>22019/10/14 12:12:12</div>
//                         </div>
//                     </div>
//                     <div class="xq349">
//                         <div class="xqleft349"></div>
//                         <div class="xq34right9">
//                             <span>订单以提交</span>
//                             <div>22019/10/14 12:12:12</div>
//                         </div>
//                     </div>
