...
var district = 	[
					/*北京市*/
					[
					 	["东城区", "西城区", "朝阳区", "海淀区", "石景山区", "丰台区", "通州区", "顺义区", "昌平区", "门头沟区", "房山区", "大兴区", "平谷区", "怀柔区"],
					 	["密云县", "延庆县"]
					], 	
					/*天津市*/
					[
...
function initAreaSelect(id, callback) {
	selectedCB = callback;
	/*打开省市区选项*/
	$("#"+id).click(function() {
		$("#areaMask").fadeIn();
