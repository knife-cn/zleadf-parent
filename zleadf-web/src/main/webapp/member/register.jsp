...
<div class="wrap">
	...
	<div class="login-info" style="height:4.85rem;">
		...
		<div class="info">
			...
			<div class="info-input">
				<img class="info-input-img"  src="img/icon-yanzhengma.png" alt=""/>
				<div class="info-input-div" id="yzdiv">
					<img src="img/img-dianred.png" alt=""/>
					<input class="login-input" type="text" id="yaninput" name="yaninput" placeholder="请输入验证码" onblur="yanzheng()" >
				</div>
			</div>
			<div class="info-input">
			<div class="yanzhengma" id="">验证码</div>
			<input id="yzcode" type="hidden" name="yzcode"/>
			</div>
		</div>
	</div>
