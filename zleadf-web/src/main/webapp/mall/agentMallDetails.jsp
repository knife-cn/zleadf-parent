...
<meta charset="utf-8" />
		...
		<script type="text/javascript" src="js/control/agentMallDetails.js"></script>
...
<div class="detailsInfo">
	...
	<div class="details">
		...
		<p class="details-3" style="margin-top:0.25rem;"><img src="img/img-quan.png" alt=""/><span style="line-height:0.02rem;">售价<label id="marketPrice" style="color:#ff8a22;margin-left:0.24rem;font-size:0.5rem;"></label></span><span style="float:right;line-height:0.02rem;" id="hidePrice">代理价<label id="price" style="color:#fa264f;margin:0 0.12rem;font-size:0.6rem;"></label>RMB</span></p>
