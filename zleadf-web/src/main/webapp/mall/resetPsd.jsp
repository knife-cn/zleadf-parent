...
<meta charset="utf-8" />
		...
		<script type="text/javascript" src="js/control/resetPsd.js"></script>
</head>
<body>
<div id="errorMsg"></div>
<!-- <div id="loding">
...
<div class="wrap">
	...
	<div class="login-info" style="height:3.2rem">
		...
		<div class="info">
			<div class="info-input">
				...
				<div class="info-input-div">
					...
					<input class="login-input" type="password" id="oldPass" name="oldPass" placeholder="请输入旧密码">
				</div>
			</div>
			<div class="info-input">
				<img class="info-input-img" src="img/icon-password.png" alt=""/>
	...
	<div class="bottom-button">
		<img class="bottom-button-1" onclick="resetPsd()" src="img/btn-queren.png" alt="">
