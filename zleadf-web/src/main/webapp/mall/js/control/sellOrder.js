                    ...
                    if (res.code == 1) {
                        ...
                        if (res.data.result.length > 0) {
                            for (var i = 0; i < res.data.result.length; i++) {
                                ...
                                html += '<p class="listINfo-2-p mt">'+'<img src="img/img-quan.png" alt="">'+res.data.result[i].consignee + '</p>';
                                html += '<p class="mt">';
                                ...
                                html += '<p class="mt">';
                                html += '<img src="img/img-quan.png" alt="">';
                                html += '<span class="listINfo-2-span">' + res.data.result[i].address + '</span>';
                                html += '</p>';
                                html += '<p>';
                                html += '<img src="img/img-quan.png" alt="">';
                                html += '<span class="listINfo-2-span">需支付金额</span>';
                                html += '<span class="listINfo-2-price">RMB<label>' + res.data.result[i].goodsAmount + '</label></span>';
                                html += '</p>';
                                html += '</div>';
                                html += '</div>';
                                ...
                                if (res.data.result[i].status == 0) {
                                    ...
                                    html += '<div class="listBtn-btn">';
                                    html += '<button class="btn btn-success"  onclick="sendGoods(' + res.data.result[i].id + ',' + i + ')">发货</button>';
                                    html += '</div>';
                                } else if (res.data.result[i].status == 3) {
                                    html += '<div class="listBtn-btn">';
